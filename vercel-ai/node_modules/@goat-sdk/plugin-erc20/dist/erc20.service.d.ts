...
declare class Erc20Service {
    ...
    getTokenBalance(walletClient: EVMWalletClient, parameters: GetTokenBalanceParameters): Promise<string>;
    ...
    getTokenAllowance(walletClient: EVMWalletClient, parameters: GetTokenAllowanceParameters): Promise<string>;
    ...
    convertToBaseUnit(parameters: ConvertToBaseUnitParameters): Promise<string>;
    convertFromBaseUnit(parameters: ConvertFromBaseUnitParameters): Promise<string>;
}
